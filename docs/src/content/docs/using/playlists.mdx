...
Flows refresh on a schedule and use your flow settings. Static playlists come from Spotify, Apple Music, SoundCloud URLs, JSON files, or exported flow tracklists.
...
Use **Import playlist** for Spotify, Apple Music, SoundCloud URLs, or a JSON tracklist. See [Playlist imports](/using/playlist-imports/).
...
- [Playlist imports](/using/playlist-imports/): Spotify and Apple Music connections, public URLs, JSON formats, retries, and file reuse
